...
export const AboutMeDialog = ({
  ...
  const onSubmit: SubmitHandler<AboutMeFormValues> = (values) => {
    if (userId) {
      UserAPI.updateProfile(userId, { bio: values.aboutMe }).catch(() => {})
    }
    setValue(values)
    setOpen(false)
  }
...
// ============================================================
// MoreInfoForm (internal) + MoreInfoDialog
// ============================================================
...
export const MoreInfoDialog = ({
  ...
  const onSubmit: SubmitHandler<MoreInfoFormValues> = (values) => {
    ...
    if (userId) {
      ...
      if (values.earning) payload.rateMin = values.earning
      if (values.clientRate) payload.rateMax = values.clientRate
      UserAPI.updateProfile(userId, payload).catch(() => {})
    }
...
// ============================================================
// AvailabilityDialog (refactored with controllable open/close)
// ============================================================
...
export const IndustryExpertiseDialog = ({
  opened,
  onOpenedChange,
  trigger: triggerProp,
  defaultValue,
...
// ============================================================
// AffiliatedTeamsDialog + AffiliatedTeams1
// ============================================================

export const AffiliatedTeamsDialog = ({
  trigger,
  opened,
  onOpenedChange,
}: {
